...
class TestCitation:
    ...
    def test_citation_minimal(self):
        ...
        citation = Citation(title="Recipe Title", url="https://example.com")
...
class TestRecipe:
    ...
    def test_get_all_citations(self, sample_recipe):
        ...
        additional_citation = Citation(
            title="Food Network Carbonara", url="https://foodnetwork.com/carbonara"
        )
    ...
    def test_add_citation(self, sample_recipe):
        ...
        new_citation = Citation(
            title="Serious Eats Carbonara", url="https://seriouseats.com/carbonara"
        )
    ...
    def test_add_duplicate_citation(self, sample_recipe):
        ...
        citation = Citation(
            title="Duplicate Citation", url="https://example.com/duplicate"
        )
...
class TestConversionFunctions:
    ...
    def test_convert_recipe_result_to_recipe(self, sample_recipe_result):
        ...
        assert (
            ...
            == sample_recipe_result.metadata.dietary_restrictions
        )
        assert (
            recipe.calories_per_serving
            == sample_recipe_result.metadata.calories_per_serving
        )
    ...
    def test_convert_citations_empty_data(self):
        ...
        citation_dicts = [{"title": "", "url": "", "snippet": None}]
