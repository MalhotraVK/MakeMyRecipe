...
class TestEnhancedRecipeAPI:
    ...
    def test_enhanced_search_endpoint_exists(self, client):
        ...
        response = client.post("/recipes/search/enhanced", json={
            "query": "test query"
        })
    ...
    def test_enhanced_search_success(self, mock_recipe_service, client, sample_recipe):
        ...
        assert recipe["description"] == "Classic Italian pasta dish with eggs, cheese, and pancetta"
    ...
    @patch("src.makemyrecipe.api.routes.recipe.recipe_service")
    def test_enhanced_search_multiple_recipes(self, mock_recipe_service, client, sample_recipe):
        ...
        second_recipe = Recipe(
            ...
            instructions=["Cook pasta", "Sauté mushrooms", "Mix eggs and cheese", "Combine"],
            prep_time=10,
            cook_time=15,
            servings=4,
    ...
    @patch("src.makemyrecipe.api.routes.recipe.recipe_service")
    def test_enhanced_search_preserves_search_query(self, mock_recipe_service, client, sample_recipe):
